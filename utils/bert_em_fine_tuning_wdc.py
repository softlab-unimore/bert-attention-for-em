...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='BERT EM fine-tuning on WDC')
    ...
    parser.add_argument('-per_device_train_batch_size', '--per_device_train_batch_size', default=32, type=int,
                        help='batch size per device during training')
    parser.add_argument('-per_device_eval_batch_size', '--per_device_eval_batch_size', default=32, type=int,
                        help='batch size for evaluation')
    parser.add_argument('-warmup_steps', '--warmup_steps', default=1000, type=int,
                        help='number of warmup steps for learning rate scheduler')
    parser.add_argument('-weight_decay', '--weight_decay', default=0.01, type=float,
                        help='strength of weight decay')
    parser.add_argument('-logging_steps', '--logging_steps', default=1000, type=int,
                        help='logging_steps')
    ...
    out_model_path = os.path.join(RESULTS_DIR, f"{args.use_case}_{args.tok}_tuned")
